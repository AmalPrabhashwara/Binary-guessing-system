...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {SevenSegDisplay[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegDisplay[6]}]
set_property PACKAGE_PIN W6 [get_ports {SevenSegDisplay[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegDisplay[5]}]
set_property PACKAGE_PIN U8 [get_ports {SevenSegDisplay[4]}]					
...
set_property PACKAGE_PIN U5 [get_ports {SevenSegDisplay[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegDisplay[2]}]
set_property PACKAGE_PIN V5 [get_ports {SevenSegDisplay[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegDisplay[1]}]
set_property PACKAGE_PIN U7 [get_ports {SevenSegDisplay[0]}]					
...
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out[1]}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {out[2]}]					
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {ShowTrueFalse[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ShowTrueFalse[0]}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {ShowTrueFalse[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ShowTrueFalse[1]}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {ShowTrueFalse[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ShowTrueFalse[2]}]
##Sch name = JB4
